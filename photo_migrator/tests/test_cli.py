...
class TestPhotom(test_utils.TempDirMixin, unittest.TestCase):
    """ Test photom commands """

    def setUp(self):
        test_utils.TempDirMixin.setUp(self)
        self.source_dir = os.path.join(self.temp_dir, "source_dir")
        shutil.copytree(test_utils.TEST_IMAGES_DIR, self.source_dir)
    ...
    def test_photom_downsize(self):
        ...
        large_filename = os.path.basename(test_utils.IMG_NO_DATETIME_LARGE)
